...
module AlchemyContentable
  module ControllerMixin
    ...
    def self.included(controller)
      ...
      controller.layout :layout_for_page
    end
    ...
    def add_contentable_to_view_path
      prepend_view_path "views/contentables"
    end
    ...
    def render_page_or_redirect
      @page ||= load_page
      if Alchemy::User.admins.count == 0 && @page.nil?
